...
layout: post
---
So this one's going to be about books. If literature is not your thing, maybe staring at this post might not be the best way to pass your time. I read fiction mostly. I tried non-fiction but never really got into it. Many have tried to make me read inspirational propoganda like `A monk who sold his ferrari`, you know the kind. Fortunately, I never gave in. So I will give you my favourite fiction works and let you decide.

>Disclaimer: Just a list of books I've read and suggest you to consider. I don't claim them to be the eternal classics that everyone's gotta read. Sure I will miss <s>some</s> most of the best ones that have been there, feel free to suggest some yourself below in the comments.

I can go and blabber about how good each one is but I am going to keep it short and simple. 
...
This is undoubtedly a timeless classic. Any decent book reader worth his salt will have read this at some point of his life. The author deals with the conditions prevailing around 1930s and all the prejudice that the oppressed were subjected to. You have an unconvential hero who in the form of `Atticus Finch`. He is a father of two kids and stands up for human values inspite of the social stigmas that existed at that time. Couldn't be better explained:
...
A classic in its own sense maybe not in a conventional way. It is a satirical work and deals with war. Even though it was intended as a comedy, it raises some fundamental questions regarding war. We have a POV of `Yossarain` who doesn't see any point in fighting and wants to go home (kind of like [Blackadder](http://www.dvdactive.com/images/reviews/screenshot/2002/5/blackadder2_copy0.jpg) in [Blackadder Goes Fourth](http://en.wikipedia.org/wiki/Blackadder_Goes_Forth), which is an awesome piece of work itself). The catch itself:
...
I read this immediately after reading `To Kill a Mocking Bird` on my glorious phone. It is set in the suburban British India around 1920s IRC. Many might consider it to be a children's book. Trust me, you will not regret reading it. Even a reread once in a while is worthwhile. R.K.Narayan is one of the best writers this country has produced. We have a POV of a 10 year old kid, `Swami` and revisit all that we had to deal with as a kid, though the world we live in is very different.
...
This one was also a random buy from the 2nd hand book shop (before I got my nexus, I used to read physical books like a savage). 
A cold war spy novel involving `KGB` and `MI6`, the Russian and the British agencies repectively. A pleasant surprise if haven't read any cold war spy novels yet. Involves lots of schemes, plots and subplots. The ending is as good as it gets. A must read if you are into cold war fiction. There is also a [movie](www.imdb.com/title/tt0093044/), it seems, starring none other than `Pierce Brosnan`.

##On Dan Brown's books
I have read [Deception Point](),[Digital Fottress](),[Da Vinci Code](),[Angels and Demons]() and [Lost Symbol](). The first two books are writen in a different style to the others. I have thoroughly enjoyed `Da Vinci Code`. I read `Angels and Demons` and it was a good read. And then when I finished `Lost Symbol`, it struck me. He has effectively published the same book three times. Don't get me wrong on this, I have nothing against `Dan Brow`. But if you take a step back and consider the three books, they have essentially the same plot flow. It took me three books to realise this and I passed `Inferno` when it came. I don't think I will read a `Dan Brown` book after what I've been through reading `Lost Symbol`. I am tired of reading the same stuff over and over. I would suggest you to read [Da Vinci Code](). Deception Point and Digital Fottress are decent reads too.

##On Jeffrey Archer's books
Jeffrey Archer is the typical modern author. He has been consistently producing best-sellsers. His books are packed with suspense, humor and have what it makes you to turn pages. They might not be the most classiest works, but they sure are good reads. `Kane and Abel` is a blast.`Prisoner of Birth` is also a fantastic piece of work. `Shall we tell the President` is a typical Americanish novel. `False Impression` also deserves a mention. Man, I am running out of adjectives. I would suggest you to read both `Kane and Abel` and `Prisoner of Birth`. It can't get any better.
...
The first book `Only Time will Tell` is one of the best finctional works I have ever read. It was quality. Trust me, [no ragrets](http://youtu.be/rjkLKKgOMRY?t=25s). It covers the time period between 1920 and the begining of Second World War. Set in Britain, it has great British elements
> The English are the biggest snobs on earth Harry.

It starts with the line 
> I was told that my father was killed in the war
No. It is not a tale of gloom.  
...
This is really not my genre. I was never into fantasy. I didn't read any of Tolkien's works or Harry Potter. I haven't even seen the movies (OMG!!!) seriously. But I started watching GOT during my 2nd year at Kharagpur. As I was discussing with it a friend, he commented how the books provide great detail the show is missing out. I didn't really take it seriously and never gave it a try. But this guy's propoganda incresed exponentially over time with his hints of spoilers. I had finally decided to read the books in the summer. As I started my internship, my daily commute clocked around 90 minutes(to and fro). Around 15 minutes to wait for the city bus(if I was really unlucky) and around 30 minutes for the journey itself. So I started reading `A Game of Thrones` on my phone(upgraded to nexus, thanks to my bro) during the commute daily. Once I got into it, there was no way out. There were times I nearly missed my stop and didn't notice the bus arriving at the stop. I started reading it late night until 3 or 4 am as my work hours were flexible. So I finished the five books in two months. I would have to admit that I blazed through some parts. The `Mereen` arc irritated me to no end. I love `Kelly C` and her `Dr.Agon`s but it was a really slow part of the books. Especially in the last book.

`ASOIAF` is the definition of epicness, not in the vastness of its world, but its characters. The world building that goes on into the books is amazing. You've gotto love this [subreddit](http://reddit.com/r/asoiaf). The theories are excruciating. But the main theme of `ASOIAF` is not the fantasy. It's not about the dragons or the whitewalkers. It's about human nature. `It's about the human heart in conflict with itself`.This quote from `GRRM` himself sums up it perfectly:
...
<br />Stannins the Mannis about Lord Celtigar
